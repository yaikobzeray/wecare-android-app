...
//        Where we change to signup

         signUpText = findViewById(R.id.loginText);
        forgotpassword = findViewById(R.id.forgotPassword);


        SpannableString forgotenpassword = new SpannableString(forgotpassword.getText());
        ...
        forgotenpassword.setSpan(clickableSpan2,0, 15, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        forgotpassword.setText(forgotenpassword);
...
//        where we acceot the email and password from te user and signin in to firease


        emailText = findViewById(R.id.loginEmailField);
        passwordText = findViewById(R.id.loginPasswordField);
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    updateUI(user);
                                    Intent intent = new Intent(LoginActivity.this, CompanyMainDashboard.class);
